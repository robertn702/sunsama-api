...
- e0e5733: Fix package build output structure (v0.13.0 regression)
...
- b12ef6f: Add subtask management methods: createSubtasks, updateSubtaskTitle, completeSubtask, uncompleteSubtask, and addSubtask
...
- 6eb22d3: Fix rich text formatting in task notes (fixes #17)
